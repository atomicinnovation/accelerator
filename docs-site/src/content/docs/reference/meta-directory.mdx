...
- meta/
  - work/ work items (`NNNN-title.md`)
  - plans/ phased implementation plans
  - research/
    - codebase/ codebase research documents
    - issues/ root-cause analyses (RCAs)
    - design-inventories/ design inventory snapshots
  ...
  - reviews/
    - plans/ plan review artefacts
    - prs/ PR review artefacts
    - work/ work-item review artefacts
  - global/ cross-repo / org-wide context
...
`documents-analyser` [agents](agents.md) search _all_ configured paths
...
Codebase research documents, RCAs, reviews, validations, and PR descriptions
are point-in-time artefacts (`status: complete`); notes are `captured`.
