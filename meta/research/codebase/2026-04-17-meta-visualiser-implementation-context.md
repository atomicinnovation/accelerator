...
title: "Meta visualiser v1 — implementation context and phasing"
schema_version: 1
---

# Meta visualiser v1 — implementation context and phasing
...
| research    | `meta/research/codebase/`      | 17        | `YYYY-MM-DD-<slug>.md`                                                                                             | rich: `date`, `researcher`, `git_commit`, `branch`, `repository`, `topic`, `tags`, `status`, `last_updated`, `last_updated_by` — consistent          |
...
- `meta/notes/2026-03-24-yaml-block-sequence-array-parsing.md` — array-parsing
  edge cases.
- `meta/research/codebase/2026-03-18-meta-management-strategy.md` — conceptual model for
  doc types.
...
- `meta/research/codebase/2026-03-18-meta-management-strategy.md` — the conceptual model
...
- `meta/research/codebase/2026-03-22-skill-customisation-and-override-patterns.md` — the
