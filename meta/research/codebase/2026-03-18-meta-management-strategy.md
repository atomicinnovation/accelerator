...
|---------------------|-------------------------------------------|-----------------------------|--------------------------------------------------|
| `research-codebase` | `meta/research/codebase/YYYY-MM-DD-description.md` | Markdown + YAML frontmatter | `create-plan`, `documents-locator`               |
...
|------------------|-------------------------------------------|---------------------------------|
| `create-plan`    | `meta/tickets/`, `meta/research/codebase/`         | Context gathering               |
...
| `extract-adrs`   | `meta/research/codebase/`, `meta/plans/`, `meta/decisions/` | Source documents + existing ADRs |
...
- `meta/research/codebase/` — exists, populated
...
`meta/reviews/` directory mirrors the existing `meta/research/codebase/` and
`meta/plans/` patterns.
