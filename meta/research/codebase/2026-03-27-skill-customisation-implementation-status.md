...
`meta/research/codebase/2026-03-22-skill-customisation-and-override-patterns.md` been
...
6. **Dynamic cross-references in default templates**: The default plan template
   references `meta/research/codebase/` etc. Users who override paths but use the
...
- `meta/research/codebase/2026-03-22-skill-customisation-and-override-patterns.md` —
  ...
  Strategy D (Hybrid)
- `meta/research/codebase/2026-03-15-context-management-approaches.md` — Earlier
...
- `meta/research/codebase/2026-03-14-plugin-extraction.md` — Plugin extraction research
...
5. **How should default templates handle path cross-references?** The default
   plan template references `meta/research/codebase/` etc. If paths are overridden,
