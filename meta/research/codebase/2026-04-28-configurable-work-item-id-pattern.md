...
- Migration tests covering: pattern-lacks-project (no-op), single-project
  ...
  `meta/research/codebase/`, strict-form prose references, and the case where some files
...
- `meta/research/codebase/2026-04-08-ticket-management-skills.md:891-897` (Resolved
...
- `meta/research/codebase/2026-04-08-ticket-management-skills.md:916-920` (Resolved
...
- `meta/research/codebase/2026-03-18-adr-support-strategy.md` — establishes the parallel
