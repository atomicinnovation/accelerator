...
`meta/research/2026-04-08-ticket-management-skills.md`. A grep through
...
- `meta/research/2026-04-08-ticket-management-skills.md` — original research
  introducing the term "ticket". Naming alternatives were not explicitly
  considered.
- `meta/research/2026-03-18-meta-management-strategy.md` — establishes the
...
- `meta/research/2026-04-08-ticket-management-skills.md` — original
  ticket-skill design
- `meta/research/2026-03-18-meta-management-strategy.md` — meta directory
  philosophy
- `meta/research/2026-03-22-skill-customisation-and-override-patterns.md` —
  user-side override patterns
- `meta/research/2026-03-28-initialise-skill-requirements.md` — closest
