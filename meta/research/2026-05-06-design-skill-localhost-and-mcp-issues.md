...
- `meta/research/2026-05-02-design-convergence-workflow.md` — the design-convergence research; evaluates browser automation tools (lines 459-466) but not integration shapes; flags Playwright MCP as "first MCP dependency" (line 495).
...
- Commit `bf60483a3` (HEAD on main = `45bb6b46`) — current revision; design-convergence work is shipped as `meta/design-gaps/`, `meta/design-inventories/` document types and the two skills.

## Related Research

- `meta/research/2026-05-02-design-convergence-workflow.md` — original feasibility research for the design-convergence workflow.
