...
| 15–21     | Core responsibilities list     | `meta/research/`, `meta/plans/`, `meta/decisions/`, `meta/reviews/`, `meta/validations/`, `meta/global/` |
| 49–59     | ASCII directory tree diagram   | All 8 subdirectories as literal strings |
| 75–100    | Output-format example block    | `meta/work/`, `meta/research/`, `meta/plans/`, `meta/notes/`, `meta/decisions/`, `meta/reviews/plans/`, `meta/reviews/prs/`, `meta/validations/`, `meta/prs/` |
...
- `meta/research/2026-02-22-skills-agents-commands-refactoring.md` — lines
