...
const TYPE_COPY = {
  ...
  "topic-research": {
    purpose:  "Subject dossiers — brief, outline, findings and synthesis accreted into one citable set.",
    when:     "Open one when an external subject will be researched iteratively and cited from later work.",
    examples: ["Model Context Protocol", "Prompt caching economics"],
    template: "topic-research",
    path:     "meta/research/topics/<slug>/",
  },
  research: {
