...
#### `meta/research/2026-05-07-0035-topbar-component.md` and
...
- **`meta/research/2026-05-06-0033-design-token-system.md:30,250`** —
...
- **`meta/plans/2026-05-06-0033-design-token-system.md:160-163,167-168,
  ...
  and `--ac-font-body`).
- **`meta/research/2026-05-07-0035-topbar-component.md:310-316`** —
...
- `meta/research/2026-05-06-0033-design-token-system.md` — token system
  research that defined 0034's foundation.
- `meta/research/2026-05-07-0035-topbar-component.md` — Topbar research
  that defined the slot contract 0034 consumes.
- `meta/research/2026-05-02-design-convergence-workflow.md` — overarching
