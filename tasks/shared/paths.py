...
# The third-party attribution notice for both distributed closures — the Rust
# cli/ workspace linked into the signed binaries and the Vite-bundled frontend
# embedded in the visualiser binary. Generated by `notices:update`, pinned by
