...
# `work`, `corpus`, and `migrate` tokens' binary crates live under
# `cli/vcs-cli/`/`cli/work-cli/`/`cli/corpus-cli/`/`cli/migrate-cli/`, not
# `cli/vcs/`/`cli/work/`/`cli/corpus/`/`cli/migrate/`, which are the domain
# crates).
