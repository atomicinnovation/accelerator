...
//!
//! A near-copy of `jira-client`'s. Sharing it would mean widening
//! `tracker-test-support`'s std-only import rule to admit `tracker_support`,
//! and these are test doubles rather than the policy the two clients must not
//! let drift.
