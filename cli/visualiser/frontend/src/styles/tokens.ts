...
export const LIGHT_COLOR_TOKENS = {
  ...
  "ac-doc-plans": "#3256b6",
  "ac-doc-codebase-research": "#b26f35",
  ...
  "ac-doc-bg-codebase-research": "#f7ece0",
  ...
  "ac-stage-codebase-research": "#c56327",
...
export const DARK_COLOR_TOKENS = {
  ...
  "ac-doc-plans": "#ffffff",
  "ac-doc-codebase-research": "#ffffff",
  ...
  "ac-doc-bg-codebase-research": "#1d2030",
  ...
  "ac-stage-codebase-research": "#e29560",
...
export const LIGHT_SHADOW_TOKENS = {
  ...
  "shadow-crisp":
    "0 1px 2px rgba(10, 17, 27, 0.06), 0 4px 12px rgba(10, 17, 27, 0.04)",
  "ac-shadow-soft":
    "0 1px 2px rgba(10,17,27,0.04), 0 8px 28px rgba(10,17,27,0.06)",
  "ac-shadow-lift":
    "0 2px 4px rgba(10,17,27,0.06), 0 20px 60px rgba(10,17,27,0.10)",
} as const;
...
export const BRAND_ALIAS_PAIRS: ReadonlyArray<
  readonly [BrandColorToken, BrandColorToken]
> = [
