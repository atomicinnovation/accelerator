...
pub use crate::legacy_alias::emit_deprecation_once;
pub use crate::legacy_alias::resolve_with_deprecated_fallback;
pub use crate::legacy_alias::AliasedScalar;
pub use crate::legacy_alias::REMOVAL_RELEASE;
