...
describe("URL matrix", () => {
  it("/library/templates shows Library → Templates trail", () => {
    vi.mocked(useMatches).mockReturnValue([
      ...
      makeMatch({
        ...
        routeId: "/library",
        pathname: "/library",
        loaderData: { crumb: "Library" },
      }),
      makeMatch({
        id: "/library/templates",
        routeId: "/library/templates",
        pathname: "/library/templates",
        loaderData: { crumb: "Templates" },
      }),
    ] as any);
    render(<Breadcrumbs />);
  ...
  it("/library/templates/adr shows Library → Templates → adr trail", () => {
    vi.mocked(useMatches).mockReturnValue([
      ...
      makeMatch({
        id: "/library/templates/adr",
        routeId: "/library/templates/$name",
        pathname: "/library/templates/adr",
        loaderData: { crumb: "adr" },
      }),
    ] as any);
    render(<Breadcrumbs />);
  ...
  it("/library/decisions shows Library → decisions trail", () => {
    vi.mocked(useMatches).mockReturnValue([
      ...
      makeMatch({
        ...
        routeId: "/library/$type",
        pathname: "/library/decisions",
        loaderData: { crumb: "decisions" },
      }),
    ] as any);
    render(<Breadcrumbs />);
    ...
    expect(screen.getByText("decisions")).toHaveAttribute(
      "aria-current",
      "page",
    );
  });
  ...
  it("/library/decisions/foo-slug shows Library → decisions → foo-slug trail", () => {
    vi.mocked(useMatches).mockReturnValue([
      ...
      makeMatch({
        id: "/library/decisions/foo-slug",
        routeId: "/library/$type/$fileSlug",
        pathname: "/library/decisions/foo-slug",
        loaderData: { crumb: "foo-slug" },
      }),
    ] as any);
    render(<Breadcrumbs />);
    ...
    expect(screen.getByText("foo-slug")).toHaveAttribute(
      "aria-current",
      "page",
    );
  });
  ...
  it("/lifecycle/cluster-x shows Lifecycle → cluster-x trail", () => {
    vi.mocked(useMatches).mockReturnValue([
      ...
      makeMatch({
        ...
        routeId: "/lifecycle",
        pathname: "/lifecycle",
        loaderData: { crumb: "Lifecycle" },
      }),
      makeMatch({
        id: "/lifecycle/cluster-x",
        routeId: "/lifecycle/$slug",
        pathname: "/lifecycle/cluster-x",
        loaderData: { crumb: "cluster-x" },
      }),
    ] as any);
    render(<Breadcrumbs />);
    ...
    expect(screen.getByText("cluster-x")).toHaveAttribute(
      "aria-current",
      "page",
    );
  });
