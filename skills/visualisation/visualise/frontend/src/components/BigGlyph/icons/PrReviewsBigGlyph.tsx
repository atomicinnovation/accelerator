...
export const PrReviewsBigGlyph: BigGlyphDraw = (p) => (
  <g>
    <g transform="rotate(-3 40 40)">
      ...
      {/* added lines */}
      <rect x="22" y="22" width="34" height="4" rx="1" fill={PR_REVIEW_DIFF_TINTS.addedBg} />
      <rect x="22" y="28" width="28" height="4" rx="1" fill={PR_REVIEW_DIFF_TINTS.addedBg} />
      <text x="17" y="26" fontFamily="ui-monospace, monospace" fontSize="5.5" fill={PR_REVIEW_DIFF_TINTS.addedMarker} textAnchor="middle">+</text>
      <text x="17" y="32" fontFamily="ui-monospace, monospace" fontSize="5.5" fill={PR_REVIEW_DIFF_TINTS.addedMarker} textAnchor="middle">+</text>
      {/* removed lines */}
      <rect x="22" y="36" width="30" height="4" rx="1" fill={PR_REVIEW_DIFF_TINTS.removedBg} />
      <text x="17" y="40" fontFamily="ui-monospace, monospace" fontSize="5.5" fill={PR_REVIEW_DIFF_TINTS.removedMarker} textAnchor="middle">−</text>
      {/* context lines */}
    ...
    <g transform="translate(46 46)">
      <path d="M0 4 a4 4 0 0 1 4 -4 h16 a4 4 0 0 1 4 4 v8 a4 4 0 0 1 -4 4 h-13 l-4 4 v-4 h-1 a4 4 0 0 1 -4 -4 z" fill={p.deep} />
