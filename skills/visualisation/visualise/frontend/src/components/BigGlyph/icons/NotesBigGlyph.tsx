...
export const NotesBigGlyph: BigGlyphDraw = (p) => (
  <g>
    ...
    <g transform="rotate(-5 40 18)">
      ...
      {/* note body */}
      <path d="M14 16 L66 16 L66 60 L58 66 L14 66 Z" fill={p.fill} stroke={p.stroke} strokeWidth="1.5" strokeLinejoin="round" />
      {/* peeled corner */}
      <path d="M66 60 L58 66 L58 60 Z" fill={p.fold} stroke={p.stroke} strokeWidth="1.3" strokeLinejoin="round" />
      {/* content lines */}
