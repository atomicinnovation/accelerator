...
describe('Page', () => {
  it('renders the required title as an h1', () => {
    render(<Page title="Library"><p>body</p></Page>)
  ...
  it('renders the eyebrow when provided', () => {
    render(<Page eyebrow="LIBRARY" title="Library">x</Page>)
  ...
  it('renders the subtitle when provided', () => {
    render(<Page title="Library" subtitle="12 documents">x</Page>)
  ...
  it('renders the actions slot when provided', () => {
    render(<Page title="Library" actions={<button>Action</button>}>x</Page>)
  ...
  it('binds default max-width to --ac-content-max-width via CSS module source', () => {
    expect(pageCss).toMatch(/\.page\s*\{[^}]*max-width:\s*var\(--ac-content-max-width\)/)
  })
