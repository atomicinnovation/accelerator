...
const EXCEPTIONS: ReadonlyArray<Exception & { kind: 'to-migrate' | 'irreducible' }> = [
  ...
  { file: 'components/RootLayout/RootLayout.module.css', literal: '12px', count: 2, kind: 'irreducible', reason: 'main-column scrollbar width and height — sized for visibility on touchpads and mice; no token equivalent' },
  { file: 'components/RootLayout/RootLayout.module.css', literal: '3px', count: 1, kind: 'irreducible', reason: 'main-column scrollbar thumb inset border (visually narrows the thumb without resizing the gutter) — below --sp-1 floor' },
  ...
  { file: 'components/Sidebar/Sidebar.module.css', literal: '1px', count: 10, kind: 'irreducible', reason: 'sidebar border-right, search-input border, kbd hint border, hint-kbd border, panel border, panel meta-row border-bottom, list-gap, mark padding, row-sub margin-top, animation translateY — below --sp-1 floor' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '2px', count: 3, kind: 'irreducible', reason: 'kbd vertical padding, result list gap, loadbar track height — below --sp-1 floor' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '3px', count: 1, kind: 'irreducible', reason: 'input focus-ring spread — below --sp-1 floor' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '4px', count: 4, kind: 'irreducible', reason: 'phase heading bottom padding, library-heading-hint translateX, animation translateY negative offset, hint-kbd horizontal padding — equals --sp-1 but co-located with non-token siblings' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '5px', count: 1, kind: 'irreducible', reason: 'kbd hint horizontal padding — between --sp-1 and --sp-2' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '6px', count: 7, kind: 'irreducible', reason: 'heading + nav-item vertical padding, search-clear right offset, result-row vertical padding, loading row gap, link list — between --sp-1 and --sp-2' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '7px', count: 3, kind: 'irreducible', reason: 'search input vertical padding, meta-row vertical padding — design-pinned half-step between --sp-1 and --sp-2' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '8px', count: 3, kind: 'irreducible', reason: 'kbd hint right offset, scrollbar width, panel margin-top — equals --sp-2 but co-located with non-token siblings' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '10px', count: 7, kind: 'irreducible', reason: 'library heading inline padding, section heading inline padding, phase heading inline padding, nav link inline padding, search icon left offset, input right padding, meta-row inline padding, loading row vertical padding — between --sp-2 (8px) and --sp-3 (12px)' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '12px', count: 1, kind: 'irreducible', reason: 'search-row chevron column width — fixed pixel column track' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '14px', count: 1, kind: 'irreducible', reason: 'empty-state inline padding from prototype — between --sp-3 and --sp-4' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '16px', count: 1, kind: 'irreducible', reason: 'empty-state bottom padding from prototype — equals --sp-4 but co-located with non-token siblings' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '18px', count: 1, kind: 'irreducible', reason: 'empty-state top padding from prototype — between --sp-4 and --sp-5' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '20px', count: 2, kind: 'irreducible', reason: 'clear-button width and height — no token equivalent at this hit-area size' },
  ...
  { file: 'components/Breadcrumbs/Breadcrumbs.module.css', literal: '2px', count: 2, kind: 'irreducible', reason: 'focus-ring outline width + outline-offset — below --sp-1 floor' },
  ...
  { file: 'routes/library/LibraryTypeView.module.css', literal: '12px', count: 2, kind: 'irreducible', reason: 'header-row padding-inline at .headerRow; row padding-inline at .row — equals --sp-3 but co-located' },
  ...
  { file: 'components/FilterPill/FilterPill.module.css', literal: '2px', count: 3, kind: 'irreducible', reason: 'clear-button padding + scroll padding-right + search top margin — below --sp-1 floor' },
  ...
  { file: 'components/FilterPill/FilterPill.module.css', literal: '10px', count: 2, kind: 'irreducible', reason: 'trigger padding-inline at .trigger; menu-header padding-inline at .menuHeader — between --sp-2 and --sp-3' },
  ...
  { file: 'components/FilterPill/FilterPill.module.css', literal: '8px', count: 7, kind: 'irreducible', reason: 'option/facet/heading paddings + option gaps from design — equals --sp-2 but co-located' },
