...
const EXCEPTIONS: ReadonlyArray<Exception & { kind: 'to-migrate' | 'irreducible' }> = [
  ...
  { file: 'components/Sidebar/Sidebar.module.css', literal: '2px', count: 6, kind: 'irreducible', reason: 'list-gap, mark border-radius, loadbar height + radius, kbd vertical padding, hint-kbd cap — below --sp-1 floor' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '3px', count: 4, kind: 'irreducible', reason: 'input focus-ring spread, kbd hint border-radius, hint-kbd border-radius, clear-button border-radius — below --sp-1 floor' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '4px', count: 4, kind: 'irreducible', reason: 'phase heading bottom padding, library-heading-hint translateX, animation translateY negative offset, scrollbar thumb radius — equals --sp-1 but co-located with non-token siblings' },
  ...
  { file: 'components/Sidebar/Sidebar.module.css', literal: '6px', count: 8, kind: 'irreducible', reason: 'heading + nav-item vertical padding plus search-clear right offset, panel border-radius, result-row vertical padding, loading row gap, link list — between --sp-1 and --sp-2' },
