...
const EXCEPTIONS: ReadonlyArray<Exception & { kind: 'to-migrate' | 'irreducible' }> = [
  ...
  { file: 'components/Sidebar/Sidebar.module.css', literal: '10px', count: 5, kind: 'irreducible', reason: 'heading, search-row, and library-heading-hint horizontal padding / font-size from design — between --sp-2 (8px) and --sp-3 (12px)' },
  { file: 'components/Sidebar/Sidebar.module.css', literal: '6px', count: 4, kind: 'irreducible', reason: 'heading vertical padding plus kbd horizontal padding from design — between --sp-1 (4px) and --sp-2 (8px)' },
  ...
  { file: 'routes/library/LibraryOverviewHub.module.css', literal: '96px', count: 1, kind: 'irreducible', reason: 'card fixed height (glyph + 2 body lines) — no token equivalent' },
  ...
  { file: 'components/FilterPill/FilterPill.module.css', literal: '2px', count: 2, kind: 'irreducible', reason: 'checkbox border-radius + clear-button padding — below --radius-sm' },
  { file: 'components/FilterPill/FilterPill.module.css', literal: '6px', count: 2, kind: 'irreducible', reason: 'checkmark width + scrollbar — fixed pixel' },
  ...
  { file: 'components/FilterPill/FilterPill.module.css', literal: '4px', count: 1, kind: 'irreducible', reason: 'clear-button right padding — equals --sp-1 (collocated with non-token siblings)' },
  { file: 'components/FilterPill/FilterPill.module.css', literal: '5px', count: 1, kind: 'irreducible', reason: 'badge horizontal padding — between --sp-1 and --sp-2' },
  { file: 'components/FilterPill/FilterPill.module.css', literal: '10px', count: 1, kind: 'irreducible', reason: 'badge font-size — between --size-xxs and 10.5px design value' },
