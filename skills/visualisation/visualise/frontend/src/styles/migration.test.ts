...
const EXCEPTIONS: ReadonlyArray<Exception & { kind: 'to-migrate' | 'irreducible' }> = [
  ...
  { file: 'components/Sidebar/Sidebar.module.css', literal: '10px', count: 5, kind: 'irreducible', reason: 'library heading inline padding at .libraryHeading; search-row inline padding at .searchRow; section heading inline padding at .sectionHeading; phase heading inline padding at .phaseHeading; nav link inline padding at .link — between --sp-2 (8px) and --sp-3 (12px)' },
