...
const cases: Array<[
  ...
  ['work-items',        { entryKey: '0040', clusterKey: '0040' }, 'clustered via: parent → work-item:0040'],
  ['pr-descriptions',   { entryKey: '0040', clusterKey: '0040' }, 'clustered via: parent → work-item:0040'],
