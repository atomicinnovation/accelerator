...
export const FIXTURES: ReadonlyArray<CodeSyntaxFixture> = [
  ...
  {
    lang: "typescript",
    // biome-ignore lint/suspicious/noTemplateCurlyInString: literal TypeScript source shown in the syntax-highlighting showcase — the ${name} is sample code, not a template placeholder
