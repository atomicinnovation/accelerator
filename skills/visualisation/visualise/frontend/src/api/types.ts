...
export const VIRTUAL_DOC_TYPE_KEYS = [
  "templates",
] as const satisfies readonly DocTypeKey[];
...
export type TemplateTierSource =
  | "config-override"
  | "user-override"
  | "plugin-default";
...
export const LIFECYCLE_PIPELINE_STEPS: ReadonlyArray<{
  ...
  },
  {
    ...
    label: "Plan review",
    placeholder: "no plan review yet",
  },
  {
    key: "hasValidation",
    docType: "validations",
    label: "Validation",
    placeholder: "no validation yet",
  },
  {
    key: "hasPrDescription",
    docType: "pr-descriptions",
    label: "PR descriptions",
    placeholder: "no PR description yet",
  },
  {
    key: "hasPrReview",
    docType: "pr-reviews",
 ...
 *  facet. */
export type LibrarySelection = Partial<
  Record<DocTypeKey, LibrarySelectionPerType>
>;
