...
**How to use it** — `/accelerator:create-adr [topic or description] [--supersedes ADR-NNNN]`
...
**How to use it** — `/accelerator:extract-adrs [research doc paths...]` (leave
empty to scan all)
...
**How to use it** — `/accelerator:review-adr [path to ADR] [--deprecate reason]`
