...
**How to use it** — `/accelerator:research-issue [issue description, stacktrace, or error message]`
...
**How to use it** — `/accelerator:create-note [note topic]`
...
**How to use it** — `/accelerator:conduct-spike [path to spike work item or brief, or work item number]`
...
**How to use it** — `/accelerator:review-plan [path to plan file]`
...
**How to use it** — `/accelerator:stress-test-plan [path to plan file]`
...
**How to use it** — `/accelerator:validate-plan [path to plan file]`
