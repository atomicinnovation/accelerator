...
**How to use it** — `/accelerator:commit [optional message or flags]`
...
**How to use it** — `/accelerator:describe-pr [PR number or URL]`

**Advice & guidelines** — The output structure is template-driven; eject and
edit `pr-description` via `/accelerator:configure templates eject pr-description`
...
**How to use it** — `/accelerator:review-pr [PR number or URL]`
...
**How to use it** — `/accelerator:respond-to-pr [PR number or URL]`
